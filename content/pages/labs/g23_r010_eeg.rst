...
Overview
========
The lab has two sound proof cabins with Faraday cages for EEG experiments.
Each cabin has its own KVM matrix, which allows for nearly complete flexibility
of which computer (EEG recorder, Eye Tracker, Presentation Machine, or
...
Any control station can connect to any computer — even *multiple* control
stations to the same computer.
...
.. class:: todo
  ...
  **TODO:** link to 2233RZ specs and paper
