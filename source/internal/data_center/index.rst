...
* eleven `compute nodes <compute_nodes>`_ (snake1-11)
...
The rack layout, as of 09.12.2015:
...
|     | 18 |                 |             |                                   |
+-----+----+-----------------+-------------+-----------------------------------+
|     | 19 |                 |             | 2x 10-core 2.3 GHz Xeon E5-2650v3 |
+ N/I +----+ snake11         + ?           + 96 GiB DDR4 RAM                   +
|     | 20 |                 |             |                                   |
+-----+----+-----------------+-------------+-----------------------------------+
...
|     |    |                 |             | 256 GiB RAM                       |
+-----+----+-----------------+-------------+-----------------------------------+
| 20  | 26 | snake5 & snake6 | 261309,000  | each snake:                       |
...
|     | 32 |                 |             |                                   |
+-----+----+-----------------+-------------+-----------------------------------+
| 32  | 33 | mudflap         | 264097,000  | 4x 8-core 2.6 GHz Opteron 6212    |
|     |    |                 |             | 512 GiB RAM                       |
+-----+----+-----------------+-------------+-----------------------------------+
